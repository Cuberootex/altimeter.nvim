...
function M_highlights:setup()
    -- EFIS PFD Altimeter
    self:set_hl("AltimeterCurrentLine", { fg = "#00ff00", bold = true })
    -- self:set_hl("AltimeterBorderLineWindow", { fg = "#c8c857", bold = false })
    -- self:set_hl("AltimeterCurrentLineArrow", { fg = "#c8c857", bold = false })
    self:set_hl("AltimeterBorderLineWindow", vim.api.nvim_get_hl(0, { name = "@include" }))
    self:set_hl("AltimeterCurrentLineArrow", vim.api.nvim_get_hl(0, { name = "@include" }))
